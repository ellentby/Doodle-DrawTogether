...
<ul>
  <li><b>機能説明</b><br/>
  	<ul>
	<li>mBaaSについて<br/>
  	この機能を開発するには、mBaaSの「会員管理」機能を利用します。「会員管理」は、アプリ利用者に会員登録を意識させない形で会員管理を行うことが出来ます。主な機能はユーザー登録、ログイン、ログアウトです。ここではユーザー登録機能についてのみ解説します。ログインとログアウト機能については、「Discussion」として考えてみましょう。
	</li>
	<li>アプリ機能について<br/>
