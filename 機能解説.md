...
このアプリで使いましたmBaas SDKや、ゲームスタート手順の解説など、<a href="README.md">スタートドキュメント</a>の方をご覧ください。

<h2 id="keyquestion">機能リスト</h2>
<ul>
  <li><a href="#q1">『機能一』ユーザー登録とログイン（会員管理）</a>
  ★☆☆☆☆</li>
  <li><a href="#q2">『機能二』落書きを描く機能</a>
  ★★★★☆</li>
...
<ul>
  ...
  <li><b>主な流れ</b>
  <p>1. 先ずは、ニックネーム、パスワードを輸入するためのGameobject「Name」と「Password」を生成。（<a href="readme-img/01login.gif">展示GIFを見る</a>）<br/>
  2. 登録、ログインのボタンを生成。（<a href="readme-img/02loginbuttons.gif">展示GIFを見る</a>）<br/>
  3. シーンで「Controller」と言うGameobjectを生成して、「ButtonController」をGameobjectにつきます。（<a href="readme-img/03ButtonController.gif">展示GIFを見る</a>）
  </p>
...
　<p><img src="readme-img/f1-01.jpg"/></p>
  5. 「Controller」を下にドラッグし、OnSignUp()ファンクションを選択します。（<a href="readme-img/04SignUpClick.gif">4.と5.の展示GIFを見る</a>）
  <p><img src="readme-img/f1-02.jpg"></p>
   6. 「Controller」をクリックして、ニックネームとパスワードの入力ボックスを「nameInput」と「passwordInput」にドラッグします。（<a href="readme-img/05DragInputField.gif">展示GIFを見る</a>）
...
　3. シーンで、「Line0」と言うGameobjectを生成します。「Add　Component」の所で、「LineRenderer」を生成します。「DrawLine」を「Line0」に付きます。（<a href="readme-img/06LineRenderer2.gif">展示GIFを見る</a>）<br/>
...
<ul>
  ...
  <p>「SaveImage.cs」を「Drawing」シーンの中の「Controller」に付き、MainCameraを「Camera」の所にドラッグします。（<a href="readme-img/07SaveImage.gif">展示GIFを見る</a>）</p>
...
<ul>
  ...
  <li><b>主な流れ</b>
	...
	public Sprite likeClickedSprite;
  	...
  	<p>
  	この二つのハートマークを定義し、UnityからSpriteファイルを取得する。（<a href="readme-img/08LikeSprite.gif">展示GIFを見る</a>）<br/>
...
<a href="readme-img/09SearchAnswer.gif">展示GIFを見る</a>
</p>
