...
<ul>
  <li><b>mbのデータストア機能について</b><br/>
  	<p><a href="#q4">機能四</a>の「mBaaSのデータストア機能について」部分をご覧ください。
  	</p>
  </li>
  ...
  <li id="a1"><b>ディスカッション</b>
  <br/>以上の流れで、「気に入り」機能を作成できましたが、あと一歩で、ランキング機能を完成できます。クラス「DoodleRecord」の列「Likes」（Doodleに気にりった人数）を使って、最後の一歩を御自身で試してみませんか？難易度★★☆☆☆
  <br/><b>【アンサー】</b></br>
...
<h2 id="discussionanswer">ディスカッションのアンサーを探す方法</h2>
