...
<h2>解説の流れ</h2>
 <ul>
  		...
  		「Doodle」では、mBaaSの「会員管理」、「データストア」、「ファイルストア」の３つの機能を使っています。 「Doodle」の機能に対応するmBaaSの機能を紹介します。</li>
  		<li><b>ゲーム機能の説明</b><br/>
		    「Doodle」の機能に対応するゲームの機能を紹介します。</li>
		  <li><b>主な手順</b><br/>
...
<h5>難易度/★☆☆☆☆</h5>
<ul>
  <li><b>mBaaSの機能について解説（会員管理）</b><br/>
  	<p>会員管理はmBaasが提供する機能の一つです。アプリ利用者に会員登録を意識させない形で会員管理を行えます。主な機能は会員登録、ログインとログアウトです。『機能一』で詳しく説明されるのは登録機能ですが、ログインとログアウト機能はディスカッションの方をご覧ください。
  	詳しくは<a href="http://mb.cloud.nifty.com/doc/current/user/basic_usage_unity.html">ドキュメント</a>を参照下さい。
  	</p>
  </li>
  <li><b>ゲーム機能の説明</b><br/>
  ゲームを開始する前に、ユーザーの登録（或いはログイン）は必要せれています。そして、ゲームを終了する際、終了ボタンを押すと、自動的にログアウトします。<br/>
...
<ul>
  ...
  <li><b>ゲーム機能の説明</b><br/>
	...
	<li>「LineRenderer」の関して、Unityの<a href="http://docs.unity3d.com/jp/current/ScriptReference/LineRenderer.html">ドキュメント</a>をご参照して下さい。</li>
	</ul>
  </li>
  <li><b>主な手順</b><br/><br/>
...
　<pre>
  ...
  <li><b>動作確認</b><br/>
  以上の流れで、白い線で絵を描けます。
  <ul><li>ブラッシュを色やサイズを変える機能はディスカッションの方をご覧ください。</li></ul>
...
<h5>難易度/★★☆☆☆</h5>
<ul>
  <li><b>mBaaSの機能について解説（ファイルストア）</b><br/>
  	<p>ファイルストアはmBaaSが提供している、画像やテキスト、音楽などさまざまな種類のファイルを保存することができるストレージ機能です。『機能三』で詳しく説明されるのはファイルをクラウドに保存する機能でうすが、ファイルを取得する機能はディスカッションの方をご覧ください。
  ...
  <br/>- クラウドに保存したファイルは、mBaaSの<a href="https://console.mb.cloud.nifty.com">管理画面</a>で確認できますが、
...
<h5>難易度/★☆☆☆☆</h5>
<ul>
  <li><b>mBaaSの機能について解説（データストア）</b><br/>
  	<p>データストアはmBaaSが提供している、アプリで利用されるデータを保存・共有することができるデータベース機能です。『機能四』で紹介されるのはデータの保存と取得機能です。
...
<h5>難易度/★★★☆☆</h5>
<ul>
  <li><b>mBaaSの機能について解説</b><br/>
  	<p>『機能五』で使用されるmBaaSの機能はデータストアですが、データストアの説明は<a href="#q4">機能四</a>の「mBaaSの機能について解説（データストア）」部分をご覧ください。
  	</p>
  </li>
  <li><b>ゲーム機能の説明</b><br/>
  	<ul>
...
シーン「doodles」
  ...
  <li><b>ディスカッション</b><br/>
  主な手順で、「気に入り」機能を作成できましたが、あと一歩で、ランキング機能を完成できます。クラス「DoodleRecord」の列「Likes」（Doodleに気にりった人数）を使って、最後の一歩を御自身で試してみませんか？難易度★★☆☆☆<br/>
  <a href="#a5">アンサー</a>
  </li>
</ul>
<span><a href="#keyquestion">リストに戻る</a></span>
...
<h2>ディスカッションのアンサー</h2>
<a href="discussionanswer">search keyを使う方法</a>
<ul>
