...
<ul>
  ...
  <li><b>主な流れ</b>
	...
	public Sprite likeClickedSprite;
  	...
  	<p>
  	この二つのハートマークを定義し、UnityからSpriteファイルを取得する。（<a href="readme-img/08LikeSprite.gif">動画を見る</a>）<br/>
